...
public class Play implements Screen {
    ...
    private void handleTowerPlacement(){
        ...
        if (!shop.hasTowerSelected()){
            System.out.println("No tower selected. Click a tower in the SHOP first.");
            return;
        }
        ...
        if(isBuildable(tileX, tileY)){
            ...
            Tower tower = createTowerFromSelection(shop.getSelectedTowerType());
            ...
            if (tower != null){
                ...
                // Clears selection after placing tower
                shop.clearSelection();
            }
        } else {
